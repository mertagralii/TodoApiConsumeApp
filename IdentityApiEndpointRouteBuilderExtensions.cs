...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MyIdentityApi<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : ApplicationUser, new()
    {
            ...
            ([FromBody] RegisterDto registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MyIdentityApi)} requires a user store with email support.");
            }
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MyIdentityApi)}-{finalPattern}";
